...
\input{\NumLatexRoot/numerical_reference_values.tex}
\input{\NumLatexRoot/numerical_pending.tex}
...
计算拟采用
\fi
MATLAB/OpenOCL 直接配点方法，基准网格将 $[0,T]$ 划分为
$N=\NumIntervals$ 个控制区间，设置 $T=\NumHorizon$、$d=\NumDegree$，
控制在各区间内为常数，离散非线性规划由 IPOPT 求解。
\NumMeshDetails
