...
def t1_of(p):
    ...
    den=b+(1-b)*q0; rhs=lambda t,y:[-(c0*den/N)*y[0]*y[1],(b*c0*(1-q0)/N)*y[0]*y[1]-g*y[1]]
...
# 低中高代表值（均可行且含内部拐点；R0 落在合理区间、高端不取到可行边界）
sweeps=[('beta',[0.10,0.155,0.22],r'$\beta$'),('q0',[0.05,0.15,0.30],r'$q_0$'),
        ('c0',[5,9,13],r'$c_0$'),('eta',[0.02,0.03,0.05],r'$\eta/N$')]
