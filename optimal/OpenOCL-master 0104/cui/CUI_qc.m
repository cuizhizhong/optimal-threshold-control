function [solution,times,problem] = CUI_qc
...
%% 参数
beta = 0.22;   gamma=0.1;   c_0=0.8;    q_0=0.1;  I_m = 0.02;
R_0 = beta * c_0 / gamma;
...
exportgraphics(gcf, 'CUI_qc.pdf', 'Resolution', 600, 'BackgroundColor', 'white');
end
...
daeh.setODE('S', - (p.beta * u.c + (1 - p.beta) * u.c* u.q) * x.S* x.I);
daeh.setODE('I',  p.beta* u.c * (1-u.q)* x.S* x.I - p.gamma*x.I);
end
